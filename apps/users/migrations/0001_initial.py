# Generated by Django 2.0b1 on 2017-11-08 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('secrecy', '保密'), ('male', '男'), ('female', '女')], default='secrecy', max_length=6, verbose_name='性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_phone', models.CharField(max_length=11, verbose_name='手机号')),
                ('created_at', models.DateField(default=datetime.datetime.now, verbose_name='创建时间')),
            ],
            options={
                'verbose_name': '短信验证码',
